...
public class ClassActivity extends Fragment {
    ...
    public ClassActivity(Context con) {
        this.con = con;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addConferences();
        adapter = new ClassAdapter(con, conferences);
    ...
    private void addConferences() {
        ...
        query.whereEqualTo("professor",ParseUser.getCurrentUser().getEmail());
        try {
            List<ParseObject> list = query.find();
            if (list != null) {
                for (ParseObject obj : list) {
                    ClassParseObject c = new ClassParseObject(obj);
                    conferences.add(c);
